...
use mylib::{rav1e_satd_8x4_16bpc_avx2, satd_rust::satd8x4_rust};
...
fn main() {
    ...
    unsafe {
        let satd =
            rav1e_satd_8x4_16bpc_avx2(src.as_ptr(), stride, dst.as_ptr(), stride, (1 << 12) - 1);
...
mod tests {
    use mylib::{
        rav1e_satd_4x4_16bpc_avx2, rav1e_satd_8x4_16bpc_avx2,
        satd_rust::{satd4x4_rust, satd8x4_rust},
    };
    use rand::Rng;
